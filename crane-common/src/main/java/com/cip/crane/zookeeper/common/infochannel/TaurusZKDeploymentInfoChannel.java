package com.cip.crane.zookeeper.common.infochannel;

import com.cip.crane.zookeeper.common.MachineType;
import com.cip.crane.zookeeper.common.TaurusZKException;
...
public class TaurusZKDeploymentInfoChannel extends TaurusZKInfoChannel implements DeploymentInfoChannel {
    ...
    /* (non-Javadoc)
     * @see com.cip.crane.zookeeper.common.infochannel.interfaces.DeploymentInfoChannel#setNewDeployDirListen(org.I0Itec.zkclient.IZkChildListener)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.cip.crane.zookeeper.common.infochannel.interfaces.DeploymentInfoChannel#setNewUndeployDirListen(org.I0Itec.zkclient.IZkChildListener)
     */
    @Override
