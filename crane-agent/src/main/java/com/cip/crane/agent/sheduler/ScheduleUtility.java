package com.cip.crane.agent.sheduler;


import com.cip.crane.agent.common.BaseEnvManager;
import com.cip.crane.agent.common.TaskType;
import com.cip.crane.agent.exec.Executor;
import com.cip.crane.agent.utils.AgentServerHelper;
import com.cip.crane.agent.utils.LockHelper;
import com.cip.crane.zookeeper.common.infochannel.bean.ScheduleConf;
import com.cip.crane.zookeeper.common.infochannel.bean.ScheduleStatus;
...
public class ScheduleUtility {
    ...
    public static void checkAndOperate(Executor executor, String localIp, ScheduleInfoChannel cs,boolean atStart) {
        synchronized (ScheduleUtility.class) {
        	for(ScheduleInfoChannel.Operate op: ScheduleInfoChannel.Operate.values()){
				...
				if(!cs.operateCompleted(localIp, opStr)){
                    if(atStart) {
                        ...
                        try {
                            ...
                            if(ScheduleInfoChannel.Operate.UPDATE.equals(op)){
                            ...
                            } else if(ScheduleInfoChannel.Operate.RESTART.equals(op)){
