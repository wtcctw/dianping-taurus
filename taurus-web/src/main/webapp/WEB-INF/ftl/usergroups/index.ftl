...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"${rc.contextPath}/usergroups.json",
		datatype: "json",
		mtype:"POST",
		jsonReader: {
			root:"data",
		...
		height: 350,
		colNames:[' ', 'ID', 'groupname', 'description'],
		colModel:[
			...
			{name:'groupname', index:'groupname', width:80, editable:true, editoptions:{size:"20", maxlength:"50"}},
			{name:'description', index:'description', width:80, editable:true, editoptions:{size:"20", maxlength:"50"}}
		], 
		...
		editurl: "${rc.contextPath}/usergroups.api",//nothing is saved
		caption: "加载全部应用信息"
