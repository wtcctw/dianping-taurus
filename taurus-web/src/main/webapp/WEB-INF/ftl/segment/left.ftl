    ...
    <ul class="nav nav-list">
        <li id="index">
            ...
            <ul class="submenu">
                ...
                <li id="task_center">
                    <a href="${rc.contextPath}/task_center">
                        <i class="menu-icon icon-caret-right"></i>
                        所有任务
                    </a>
                </li>
                <li id="host_center">
                    <a href="${rc.contextPath}/host_center">
                        <i class="menu-icon icon-caret-right"></i>
                        主机负载
                    </a>
                </li>
        ...
        <li id="task">
            <a href="${rc.contextPath}/task" target="_self">
                <i class="icon-edit"></i>
                <span class="menu-text">新建任务 </span>
            </a>
        </li>
        <li id="schedule">
            <a href="${rc.contextPath}/schedule" target="_self">
                <i class="icon-tasks"></i>
                <span class="menu-text"> 调度中心 </span>
            </a>
        </li>
        <li id="monitor">
            <a href="${rc.contextPath}/monitor" target="_self">
                <i class="icon-trello"></i>
                <span class="menu-text"> 任务监控 </span>
            </a>
        </li>
        <li id="host">
            <a href="${rc.contextPath}/hosts" target="_self">
                <i class="icon-desktop"></i>
                <span class="menu-text"> 主机监控 </span>
            </a>
        </li>
        <li id="cron">
            <a href="${rc.contextPath}/cronbuilder" target="_self">
                <i class="icon-indent-right"></i>
                <span class="menu-text"> Cron 生成器</span>
            </a>
        </li>
        <li id="user">
            <a href="${rc.contextPath}/user" target="_self">
                <i class="icon-user"></i>
                <span class="menu-text"> 用户设置 </span>
            </a>
        </li>
        <li id="resign">
            <a href="${rc.contextPath}/resign" target="_self">
                <i class="icon-retweet"></i>
                <span class="menu-text"> 任务交接 </span>
            </a>
        </li>
        <li id="feedback">
            <a href="${rc.contextPath}/feedback" target="_self">
                <i class="icon-comments"></i>
                <span class="menu-text"> 我要反馈 </span>
            </a>
        </li>
        <li id="update">
            <a href="${rc.contextPath}/update" target="_self">
                <i class="icon-tag"></i>
                <span class="menu-text"> 更新日志 </span>
            </a>
        </li>
        <li id="about">
            <a href="${rc.contextPath}/about" target="_self">
