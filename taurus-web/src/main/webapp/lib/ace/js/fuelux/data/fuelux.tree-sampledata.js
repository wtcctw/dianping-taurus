...
var tree_data = {
	'for-sale' : {name: 'For Sale', type: 'folder', additionalParamters: {id: '1'}}	,
	'vehicles' : {name: 'Vehicles', type: 'folder', additionalParamters: {id: '2'}}	,
	'rentals' : {name: 'Rentals', type: 'folder', additionalParamters: {id: '3'}}	,
	'real-estate' : {name: 'Real Estate', type: 'folder', additionalParamters: {id: '4'}}	,
	'pets' : {name: 'Pets', type: 'folder', additionalParamters: {id: '5'}}	,
	'tickets' : {name: 'Tickets', type: 'item', additionalParamters: {id: '6'}}	,
	'services' : {name: 'Services', type: 'item', additionalParamters: {id: '7'}}	,
	'personals' : {name: 'Personals', type: 'item', additionalParamters: {id: '8'}}
}
tree_data['for-sale']['additionalParameters'] = {
	'children' : {
		'appliances' : {name: 'Appliances', type: 'item', additionalParamters: {id: '9'}},
